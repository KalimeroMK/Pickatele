                    ...
                    <div class="col-md-12">
                        ...
                        <div class="header-left clearfix">
                            ...
                            <div id="logo" class="logo">
                                <a href="/"><img id="logo_img" src="/assets/images/logo.png" alt="Pickatale"/></span>
                                </a>
                            </div>
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                            <ul id="fullpage-menu" class="nav navbar-nav navbar-right uppercase">
                                                ...
                                                <li data-menuanchor="secondPage"><a href="#secondPage">Parents</a></li>
                                                <li data-menuanchor="thirdPage"><a href="#thirdPage">Educators</a></li>
                                                <li data-menuanchor="fourthPage"><a href="#fourthPage">Book Library</a>
                                                </li>
                                                <li data-menuanchor="fifthPage"><a href="#fifthPage">Partners</a></li>
