                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div id="horizontal-form">
                            ...
                            {{ Form::model('mainpages', array('route' => array('mainpages.store'), 'method' => 'POST', 'files'=>true)) }}
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="ckeditor form-control" id="elm1" name="sliderdescription"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="ckeditor form-control" id="elm2" name="paragraph"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="ckeditor form-control" id="elm3" name="seconddescription"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="secondheadertitle"/>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="ckeditor" id="elm4" name="thirddescription"></textarea>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="item2title"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="item2description"></textarea>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="item3description"></textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="item4title"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="item4description"></textarea>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="item5description"></textarea>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="item6title"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="item6description"></textarea>
                                    </div>
